...
const pages = ['index.html', 'nosotros.html', 'informacion.html', 'productos.html', 'login.html', 'registro.html', 'usuario/index.html', 'usuario/perfil.html', 'usuario/reservas.html', 'admin/reservas.html', 'promociones.html', 'contacto.html'];
