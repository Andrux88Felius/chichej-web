...
for (const name of await readdir(scripts)) {
  ...
  if (!['register-firebase.js','reservations-firebase.js','admin-reservations-firebase.js'].includes(name)) assert(!/\brunTransaction\s*\(/.test(source), name + ': transacciones aisladas');
